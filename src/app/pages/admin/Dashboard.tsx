  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600">{intl.formatMessage({ id: "dashboard.welcome" })}</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          ...
          <div className="text-slate-600">{intl.formatMessage({ id: "dashboard.revenue.month" })}</div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          ...
          <div className="text-slate-600">{intl.formatMessage({ id: "dashboard.growth.month" })}</div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          ...
          <div className="text-slate-600">{intl.formatMessage({ id: "dashboard.total.users" })}</div>
          <div className="text-sm text-green-600 mt-2">+12 {intl.formatMessage({ id: "dashboard.users.month" })}</div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          ...
          <div className="text-slate-600">{intl.formatMessage({ id: "dashboard.sales.month" })}</div>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex gap-2">
            {(["weekly", "monthly", "yearly", "custom"] as Period[]).map((p) => (
              ...
              >
                {intl.formatMessage({ id: `dashboard.period.${p}` })}
              </button>
            ))}
          </div>
        </div>
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 flex items-center gap-4">
            <div className="flex items-center gap-3">
              <label className="text-sm font-medium text-slate-700">
                {intl.formatMessage({ id: "dashboard.period.from" })}
              </label>
              <input
                type="date"
            ...
            <div className="flex items-center gap-3">
              <label className="text-sm font-medium text-slate-700">
                {intl.formatMessage({ id: "dashboard.period.to" })}
              </label>
              <input
                type="date"
                value={customEndDate}
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          <h2 className="text-xl font-bold text-slate-900 mb-6">
            {intl.formatMessage({ id: "dashboard.revenue.overview" })}
          </h2>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          <h2 className="text-xl font-bold text-slate-900 mb-6">
            {intl.formatMessage({ id: "dashboard.weekly.sales" })}
          </h2>
          <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="bg-white rounded-2xl border border-slate-200">
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-xl font-bold text-slate-900">
            {intl.formatMessage({ id: "dashboard.recent.bookings" })}
          </h2>
        </div>
