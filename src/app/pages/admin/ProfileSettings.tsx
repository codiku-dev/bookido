  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600">{intl.formatMessage({ id: "profile.subtitle" })}</p>
      </div>
      ...
      <div className="max-w-3xl space-y-6">
        ...
        {saved && (
          <div className="bg-green-50 border border-green-200 text-green-800 px-6 py-4 rounded-xl">
            ✓ {intl.formatMessage({ id: "profile.saved" })}
          </div>
        )}
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">
              {intl.formatMessage({ id: "profile.information" })}
            </h2>
          </div>
          ...
          <form onSubmit={handleProfileSave} className="space-y-6">
            <div>
              <label className="block text-slate-700 mb-2">
                {intl.formatMessage({ id: "profile.full.name" })}
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-slate-700 mb-2">
                {intl.formatMessage({ id: "profile.bio" })}
              </label>
              <textarea
            ...
            >
              ...
              {intl.formatMessage({ id: "profile.save.changes" })}
            </button>
          </form>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900">
              {intl.formatMessage({ id: "profile.password" })}
            </h2>
          </div>
          ...
          <form onSubmit={handlePasswordChange} className="space-y-6">
            <div>
              <label className="block text-slate-700 mb-2">
                {intl.formatMessage({ id: "profile.password.current" })}
              </label>
              <input
                type="password"
            ...
            <div>
              <label className="block text-slate-700 mb-2">
                {intl.formatMessage({ id: "profile.password.new" })}
              </label>
              <input
                type="password"
              ...
              <p className="text-sm text-slate-500 mt-2">
                {intl.formatMessage({ id: "profile.password.requirement" })}
              </p>
            </div>

            <div>
              <label className="block text-slate-700 mb-2">
                {intl.formatMessage({ id: "profile.password.confirm" })}
              </label>
              <input
                type="password"
              ...
              {passwordData.newPassword &&
                ...
                passwordData.newPassword !== passwordData.confirmPassword && (
                  <p className="text-sm text-red-600 mt-2">
                    {intl.formatMessage({ id: "profile.password.mismatch" })}
                  </p>
                )}
            </div>
            ...
            >
              ...
              {intl.formatMessage({ id: "profile.password.update" })}
            </button>
          </form>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-600"
              >
                <option value="fr">{intl.formatMessage({ id: "language.fr" })}</option>
              ...
              <label className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:bg-slate-50 cursor-pointer">
                <div>
                  <div className="font-medium text-slate-900">
                    {intl.formatMessage({ id: "profile.notifications" })}
                  </div>
                  <div className="text-sm text-slate-600">
                    {intl.formatMessage({ id: "profile.notifications.desc" })}
                  </div>
                </div>
                <input
                  type="checkbox"
        ...
        <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-red-900 mb-4">
            {intl.formatMessage({ id: "profile.danger.zone" })}
          </h2>
          <p className="text-red-700 mb-6">
            {intl.formatMessage({ id: "profile.danger.warning" })}
          </p>
          <button className="px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors">
            {intl.formatMessage({ id: "profile.delete.account" })}
          </button>
        </div>
      </div>
    </div>
