    ...
    <div className="h-full flex flex-col lg:flex-row">
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">{intl.formatMessage({ id: "calendar.title" })}</h1>
            <p className="text-slate-600">{intl.formatMessage({ id: "calendar.subtitle" })}</p>
          </div>
          <div className="flex gap-3">
            ...
            >
              ...
              {isAvailabilityMode
                ? intl.formatMessage({ id: "calendar.exit.availability" })
                : intl.formatMessage({ id: "calendar.define.availability" })}
            </button>
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-50 p-4 rounded-xl">
            ...
            >
              {intl.formatMessage({ id: "calendar.nav.today" })}
            </button>
          </div>
        </div>
        ...
        {isAvailabilityMode && (
          <div className="mb-6 bg-blue-50 border-2 border-blue-200 rounded-2xl p-6">
            <h3 className="text-lg font-bold text-slate-900 mb-4">
              {intl.formatMessage({ id: "calendar.hours.opening" })}
            </h3>
                ...
                <div key={day} className={`p-3 rounded-xl bg-white border ${weekHours[day].enabled ? "border-slate-200" : "border-slate-100"}`}>
                  <div className="flex flex-col md:flex-row md:items-center gap-3">
                    ...
                    {weekHours[day].enabled ? (
                      ...
                      <span className="text-slate-500 italic text-sm">{intl.formatMessage({ id: "calendar.hours.closed" })}</span>
                    )}
                  </div>
                </div>
              ))}
        ...
        {isAvailabilityMode && (
          <div className="mb-4 text-center">
            <h3 className="text-lg font-semibold text-slate-900">
              {intl.formatMessage({ id: "calendar.availability.instruction" })}
            </h3>
          </div>
        )}
              ...
              {!isAvailabilityMode && (
                <div className="mt-6 flex items-center gap-6 justify-center text-sm flex-wrap">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-slate-600">{intl.formatMessage({ id: "user.detail.status.confirmed" })}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-yellow-600 rounded"></div>
                    <span className="text-slate-600">{intl.formatMessage({ id: "user.detail.status.completed" })}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-red-600 rounded"></div>
                    <span className="text-slate-600">{intl.formatMessage({ id: "user.detail.status.cancelled" })}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div
      ...
      {selectedBooking && !isAvailabilityMode && (
        <div className="w-full lg:w-96 bg-white border-t lg:border-t-0 lg:border-l border-slate-200 p-4 md:p-6 overflow-auto">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-slate-900">{intl.formatMessage({ id: "booking.detail.title" })}</h2>
            <button
          ...
          <div className="space-y-6">
            <div>
              <div className="text-sm text-slate-600 mb-1">{intl.formatMessage({ id: "user.detail.status" })}</div>
              <span
              ...
              >
                {selectedBooking.status === "confirmed" ? intl.formatMessage({ id: "user.detail.status.confirmed" }) : selectedBooking.status === "pending" ? intl.formatMessage({ id: "user.detail.status.completed" }) : intl.formatMessage({ id: "user.detail.status.cancelled" })}
              </span>
            </div>

            <div>
              <div className="text-sm text-slate-600 mb-1">{intl.formatMessage({ id: "booking.detail.client" })}</div>
              <button
            ...
            <div>
              <div className="text-sm text-slate-600 mb-1">{intl.formatMessage({ id: "booking.detail.service" })}</div>
            ...
            <div>
              <div className="flex items-center gap-2 text-sm text-slate-600 mb-1">
                ...
                {intl.formatMessage({ id: "booking.detail.date.time" })}
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 text-sm text-slate-600 mb-1">
                ...
                {intl.formatMessage({ id: "booking.detail.amount" })}
              </div>
